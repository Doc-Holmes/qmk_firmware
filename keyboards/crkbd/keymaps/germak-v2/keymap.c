...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [2] = LAYOUT_split_3x6_3(KC_PLUS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_CIRC, KC_SLSH, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT, KC_GT, KC_RPRN, KC_RBRC, KC_RCBR, KC_NUBS, KC_NO, KC_LSFT, KC_EXLM, KC_ASTR, KC_GRV, KC_DLR, KC_PERC, KC_AMPR, KC_QUES, KC_HASH, KC_PIPE, KC_AT, KC_EQL, KC_NO, KC_NO, KC_TRNS, MO(3), KC_SPC, KC_ENT),
