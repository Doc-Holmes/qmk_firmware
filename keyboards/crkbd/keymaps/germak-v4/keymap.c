...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [1] = LAYOUT_split_3x6_3(KC_LSFT, KC_NO, KC_NO, KC_HOME, KC_PGUP, KC_WH_U, KC_CIRC, KC_NO, UC(0xFC), KC_DLR, UC(0xDF), KC_NO, KC_LCTL, UC(0xE4), KC_LGUI, KC_END, KC_PGDN, KC_WH_D, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, UC(0xF6), KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_SPC, KC_ENT, MO(3), KC_TRNS, KC_NO, KC_NO),
        [2] = LAYOUT_split_3x6_3(KC_PLUS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_CIRC, KC_SLSH, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT, KC_GT, KC_RPRN, KC_RBRC, KC_RCBR, KC_BSLS, KC_QUOT, KC_LSFT, KC_EXLM, KC_ASTR, KC_GRV, KC_DLR, KC_PERC, KC_AMPR, KC_QUES, KC_HASH, KC_PIPE, KC_AT, KC_EQL, KC_NO, KC_NO, KC_TRNS, MO(3), KC_SPC, KC_LCTL),
